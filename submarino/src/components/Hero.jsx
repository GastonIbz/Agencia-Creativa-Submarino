  ...
  return (
      <section className="relative w-full h-screen flex items-center justify-center">
          ...
          <div className="relative z-10 text-center text-white">
              ...
              <button
  className="mb-60 px-8 py-3 bg-custom-blue border-2 border-white text-white text-2xl font-bold shadow-lg transition-all duration-100 ease-in-out focus:outline-none focus:ring-4 focus:ring-hover-orange focus:ring-opacity-50 relative top-4 backdrop-blur-lg rounded-full hover:shadow-[0_0_70px_4px_rgba(255,87,34,.5)]"
