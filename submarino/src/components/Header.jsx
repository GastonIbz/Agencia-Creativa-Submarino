...
const Header = () => {
    ...
    return (
        <header className="flex items-center justify-between w-full py-4 px-4 h-[10vh] bg-black text-white z-50 fixed top-0 left-0 right-0">
           ...
           {/* Menú Móvil */}
           <nav className={`fixed bg-black bg-opacity-40 w-[80%] md:w-[40%] xl:hidden h-full ${showMenu ? "left-0" : "-left-full"} top-0 flex flex-col items-center justify-center gap-10 transition-all duration-500 backdrop-blur-md z-50`}>
            ...
            {/* Menú Escritorio */}
            <nav className="hidden xl:flex bg-transparent w-full h-full items-center justify-center gap-10 z-50">
                <a href="#" className="text-white py-2 text-xl ">Nosotros</a>
                <a href="#" className="text-white py-2 text-xl">Soluciones</a>
                <a href="#" className="text-white py-2 text-xl">Portafolio</a>
                <a href="#" className="text-white py-2 text-xl">Contacto</a>
